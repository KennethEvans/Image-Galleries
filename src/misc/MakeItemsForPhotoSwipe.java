...
/**
 * MakeItemsForPhotoSwipe parses the files in a directory and outputs a
 * PhotoSwipe items array in JSON format to the console. The GUI application
 * PhotoSwipeGallery now does this and more.
 * 
 * @author Kenneth Evans, Jr.e
 */
